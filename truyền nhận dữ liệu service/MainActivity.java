...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button mButtonShowNotify, mButtonReplyNotify, mButtonProgressNoti, mButtonExpandable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonExpandable = findViewById(R.id.button_expandable);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mReceiver, new IntentFilter(MyServiceService.ACTION_1));
    }
    ...
    private void makeNotification() {
        ...
        PendingIntent snoozePendingIntent = PendingIntent.getBroadcast(this, 0, notifiIntent, 0);
        mBuilder = new NotificationCompat.Builder(this, "default").setSmallIcon(
                R.drawable.ic_notifications_none_black_24dp)
                .setContentTitle("Thu cuối")
                .setContentText("Có lẽ nào mua thi chẳng còn lại gì trong tâm trí em")
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        "Cuốn theo cơn gió lặng lẽ vào trong một buổi chiều vô vọng"))
    ...
    private void replyNotification() {
        ...
        PendingIntent resultPendingIntent =
                stackBuilder.getPendingIntent(mRequestCode, PendingIntent.FLAG_CANCEL_CURRENT);
        NotificationCompat.Action replyAction =
                new NotificationCompat.Action.Builder(R.drawable.ic_reply_black_24dp, replyLabel,
                        resultPendingIntent).addRemoteInput(remoteInput)
                        .setAllowGeneratedReplies(true)
                        .build();

        mBuilder = new NotificationCompat.Builder(this, "default").setAutoCancel(true)
    ...
    private void makeProgressNotification() {
        ...
        // If the service isn't already running, the system first calls onCreate(), and then it
        // calls onStartCommand().
        startService(intent);
    }

    private void expandableNotification() {
        // cover image resoure to bigmap
        Bitmap bm = BitmapFactory.decodeResource(getResources(), R.drawable.notifi_background);
        PendingIntent
        ...
        Notification notification =
                new NotificationCompat.Builder(this, "default")
                        ...
                        .setAutoCancel(true)
                        .setSmallIcon(R.drawable.ic_notifications_none_black_24dp)
                        .setContentTitle("Noi cuoi con duong kia")
                        .setContentText("sau anh hao quang")
                        .setStyle(new NotificationCompat.BigPictureStyle().bigPicture(
                                bm)) // set backgournd
                        .setLargeIcon(null) // set big icon when collapsand
                        .build();
